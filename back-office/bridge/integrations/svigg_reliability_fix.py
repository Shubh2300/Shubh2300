# VENDORED verbatim from /home/user/Shubh2300/svigg_reliability_fix.py
# MERGE PENDING into svigg_scraper.py — see MCP_CANCEL_BOOKING_FIX.md
# Graft-ready cancel/booking reliability fixes (D1-D6); not yet wired into the vendored scraper.
